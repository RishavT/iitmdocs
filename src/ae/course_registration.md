...
description: Course registration rules after qualifying, Foundation Level registration, same-term and subsequent-term registration, exam city choices, prerequisites, course limits, and course access rules.
covers:
...
sample_queries:
  ...
  - Can first-attempt qualifiers register for courses in the same term?
  - When can second-attempt qualifiers register for courses?
  - What is the maximum number of courses per term?
  - When will course access be revoked?
---
...
For BS in Aeronautics and space technology (AE), students should fulfill the below conditions: Applicants must have studied Physics and Mathematics in Class 12 or equivalent, OR passed Physics and Mathematics through NIOS or any other equivalent organization

For BS in Aeronautics and space technology (AE), students should fulfill the below conditions: Passed class 12 or an equivalent examination regardless of age or academic background
...
## Score validity and registration terms
...
## Course choices, prerequisites, and levels
...
- same term registration
- subsequent term registration
- Quiz 1
- qualifier score
