---
title: qualifier_passing_criteria
description: Qualifier exam passing requirements, individual subject cut-offs, total cut-off, category-wise qualifier exam scores, and qualifier-specific relaxation rules.
covers:
  - qualifier exam subjects
...
sample_queries:
  ...
  - What qualifier exam score is required for General learners?
  - Do pass criteria relaxations apply only to the qualifier?
...
Tags:
- qualifier passing criteria
- qualifier exam cutoff
- individual subject cutoff
- total cutoff
- General learner score
- OBC-NCL EWS score
- SC ST PwD score
- pass criteria relaxation