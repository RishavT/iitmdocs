...
sample_queries:
  - What programs are offered in IITM BS?
  - Is the IIT Madras BS program online or offline?
  - What are the levels in the BS program?
  - What certificates can I get during the program?
  - Is the BS degree from IIT Madras valid?
...
Tags: iitm bs program, iit madras bs degree, programs offered ds es mg ae, online learning with in person exams, program structure, foundation diploma degree levels, exit points, foundation certificate iitm code, diploma from iit madras, bsc bs pgd mtech degrees, degree validity, recognized degree, study from anywhere, non campus program, academic rigor, cannot apply multiple programs, official website iitm bs, program overview