---
title: foundation_registration
description: Foundation Level registration rules after qualifier or JEE-based entry, including eligibility, course registration timing, prerequisites, exam city choices, Quiz 1 rules, credits, payments, and progression to later levels.
covers:
  - Foundation Level registration after qualifier
  - same-term and subsequent-term registration
  - course prerequisites and maximum courses
  - Quiz 1 and assignment requirements
  - progression to Diploma and Degree levels
sample_queries:
  - Can I apply for Foundation Level after qualifying?
  - When can first-attempt qualifier candidates register in the same term?
  - Can I register in the same term if I qualify in the second attempt?
  - What prerequisite rule applies to course registration?
  - What should I check before registering for Foundation Level in a subsequent term?
---

# Content

## Eligibility to proceed to Foundation Level
...
- For BS in Management and Data Science (MG), students should fulfill the below conditions: Studied Maths and English in class 10 AND Passed class 12 or an equivalent examination regardless of age or academic background
...
## JEE-based Foundation registration
...
## Registration after qualifier attempts
...
- Once the qualifier result is declared, you can register for foundational courses and continue with the BS in Management and Data Science program.
